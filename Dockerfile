...
ARG VITE_API_URL_PERMISSOES=http://devcac:7010
ARG VITE_API_BROADCAST_TOKEN=ApiKey CAC-Broadcast:CB68/J78zocdwWSe1aZ4UeZQo1KcsgqCmyn4Lzo5MeU=
ARG VITE_API_URL_EMAILS=http://devcac:7012
...
ENV VITE_API_URL_PERMISSOES=${VITE_API_URL_PERMISSOES}
ENV VITE_API_BROADCAST_TOKEN=${VITE_API_BROADCAST_TOKEN}
ENV VITE_API_URL_EMAILS=${VITE_API_URL_EMAILS}
