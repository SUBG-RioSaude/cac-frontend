...
import type { DocumentoContratoDto, SaveDocumentosMultiplosPayload } from '@/modules/Contratos/types/contrato'
...
vi.mock('@/modules/Contratos/services/documentos-service', () => ({
  saveDocumentosMultiplos: (...args: unknown[]) => mockSaveDocumentosMultiplos(...args),
...
describe('useUpdateDocumentosMultiplos', () => {
  ...
  it('deve salvar documentos múltiplos com sucesso', async () => {
    ...
    expect(mockSaveDocumentosMultiplos).toHaveBeenCalledWith(contratoId, mockPayload)
  })
  ...
  it('deve invalidar cache após sucesso', async () => {
    ...
    const { result } = renderHook(() => useUpdateDocumentosMultiplos(), { wrapper })
...
describe('useUpdateDocumentoStatus', () => {
  ...
  it('deve salvar status de documento individual', async () => {
    ...
    expect(mockSaveDocumentoStatus).toHaveBeenCalledWith(contratoId, mockDocumento)
  })
...
describe('useDeleteDocumento', () => {
  ...
  it('deve fazer optimistic update ao excluir', async () => {
    ...
    await waitFor(() => {
      const cacheData = queryClient.getQueryData(['documentos', contratoId]) as DocumentoContratoDto[]
