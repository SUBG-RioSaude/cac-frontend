...
export const contratoKeys = {
  ...
  list: (filtros?: Partial<ContratoParametros>) =>
    [...contratoKeys.lists(), filtros] as const,
  ...
  byEmpresa: (empresaId: string) =>
    [...contratoKeys.all, 'empresa', empresaId] as const,
  porEmpresa: (empresaId: string, filtros?: Partial<ContratoParametros>) =>
    [...contratoKeys.all, 'porEmpresa', empresaId, filtros] as const,
  byUnidade: (unidadeId: string) =>
    [...contratoKeys.all, 'unidade', unidadeId] as const,
  byNumero: (numero: string) =>
    [...contratoKeys.all, 'numero', numero] as const,
...
export const empresaKeys = {
  ...
  // Para mutations - keys que devem ser invalidadas
  invalidateOnCreate: () => [empresaKeys.lists(), empresaKeys.all] as const,
