...
export function ChatMessage({
  ...
  const getTipoMensagemBadge = () => {
    switch (mensagem.tipo) {
      case 'sistema':
        return (
          <Badge className="bg-blue-100 text-xs text-blue-800">Sistema</Badge>
        )
  ...
  if (mensagem.tipo === 'sistema') {
    return (
      ...
      >
        <div className="bg-muted max-w-xs rounded-full px-4 py-2 text-center">
          <p className="text-muted-foreground text-xs">{mensagem.conteudo}</p>
      ...
      >
        ...
        <div
          className={cn(
            ...
            isOwn ? 'bg-blue-500 text-white' : 'bg-muted text-foreground',
            mensagem.tipo === 'alteracao_contratual' &&
