...
export function FiltrosContratos({ filtros, onFiltrosChange, onLimparFiltros }: FiltrosContratosProps) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onFiltrosChange({ ...filtros, dataInicialDe: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onFiltrosChange({ ...filtros, dataInicialAte: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onFiltrosChange({ ...filtros, dataFinalDe: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onFiltrosChange({ ...filtros, dataFinalAte: e.target.value })}
                  />
                </div>
              </div>
            </div>
