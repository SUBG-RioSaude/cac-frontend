...
describe('DocumentosChecklist', () => {
  ...
  describe('Renderização', () => {
    ...
    it('deve renderizar checkboxes marcados quando documentos estão entregues', () => {
      ...
      expect(screen.getByLabelText('Ata de Registro de Preços')).not.toBeChecked()
      expect(screen.getByLabelText('Publicação PNCP')).not.toBeChecked()
      expect(screen.getByLabelText('Publicação de Extrato Contratual')).not.toBeChecked()
    })
  })
  ...
  describe('Interações', () => {
    it('deve chamar handleCheckedChange quando checkbox é marcado', async () => {
      ...
      const termoReferenciaCheckbox = screen.getByLabelText('Termo de Referência/Edital')
  ...
  describe('Edge Cases', () => {
    it('deve lidar com checklistData undefined/null graciosamente', () => {
      ...
      expect(screen.getByLabelText('Termo de Referência/Edital')).not.toBeChecked()
  ...
  describe('Estrutura HTML', () => {
    ...
    it('deve aplicar classes CSS corretamente', () => {
      ...
      const containers = screen.getByText('Checklist de Documentos').parentElement?.parentElement
