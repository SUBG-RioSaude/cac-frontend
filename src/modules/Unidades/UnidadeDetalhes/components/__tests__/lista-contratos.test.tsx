...
describe('ListaContratos', () => {
  ...
  describe('quando há contratos', () => {
    it('deve renderizar título com contador correto', () => {
      ...
      expect(
        screen.getByText('Lista de contratos ativos nesta unidade'),
      ).toBeInTheDocument()
    })
    ...
    it('deve renderizar objetos dos contratos', () => {
      ...
      expect(
        screen.getByText('Manutencao predial e eletrica'),
      ).toBeInTheDocument()
    })
  ...
  describe('quando não há contratos', () => {
    ...
    it('deve renderizar ícone no estado vazio', () => {
      ...
      const emptyStateContainer = screen
        .getByText('Nenhum contrato vinculado')
        .closest('div')
    ...
    it('não deve renderizar lista de contratos no estado vazio', () => {
      ...
      expect(
        screen.queryByText('Lista de contratos ativos nesta unidade'),
