...
vi.mock('../UnidadesListPage', () => ({
  default: () => <div data-testid="mocked-unidades-list-page">
    <h1>Unidades</h1>
...
describe('UnidadesListPage', () => {
  ...
  it('deve renderizar o cabeçalho da página corretamente', () => {
    ...
    expect(screen.getByText('Gerencie todas as unidades do sistema de forma eficiente')).toBeInTheDocument()
  })
  ...
  it('deve renderizar lista de unidades após carregamento', () => {
    ...
    expect(screen.getByText('Centro de Atencao Psicossocial Norte')).toBeInTheDocument()
    expect(screen.getByText('Ambulatorio de Cardiologia Zona Leste')).toBeInTheDocument()
  })
