...
export const funcionarioKeys = {
  ...
  list: (filtros?: Partial<FuncionarioParametros>) =>
    [...funcionarioKeys.lists(), filtros] as const,
  ...
  // Buscas específicas
  byMatricula: (matricula: string) =>
    [...funcionarioKeys.all, 'matricula', matricula] as const,
  byCpf: (cpf: string) => [...funcionarioKeys.all, 'cpf', cpf] as const,

  // Buscas por contexto
  byLotacao: (lotacao: string) =>
    [...funcionarioKeys.all, 'lotacao', lotacao] as const,
  ...
  invalidateOnCreate: () =>
    [funcionarioKeys.lists(), funcionarioKeys.all] as const,
...
export const lotacaoKeys = {
  ...
  list: (filtros?: Partial<LotacaoParametros>) =>
    [...lotacaoKeys.lists(), filtros] as const,
  ...
  // Para mutations - keys que devem ser invalidadas
  invalidateOnUpdate: (id: string) =>
    [lotacaoKeys.detail(id), lotacaoKeys.lists(), lotacaoKeys.all] as const,

  invalidateOnCreate: () => [lotacaoKeys.lists(), lotacaoKeys.all] as const,
...
export type FuncionarioQueryKey =
  ...
  | readonly [
      'funcionarios',
      'list',
      Partial<FuncionarioParametros> | undefined,
    ]
