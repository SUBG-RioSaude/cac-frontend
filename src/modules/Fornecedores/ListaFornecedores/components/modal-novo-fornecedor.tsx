...
export function ModalNovoFornecedor({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="block max-h-[90vh] w-screen overflow-y-auto p-8">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    value={dados.cnpj}
                    onChange={(e) =>
                      setDados((prev) => ({ ...prev, cnpj: e.target.value }))
                    }
                  />
                </div>
                <div className="space-y-4">
            ...
            <CardContent className="space-y-8">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    value={dados.cep}
                    onChange={(e) =>
                      setDados((prev) => ({ ...prev, cep: e.target.value }))
                    }
                  />
                </div>
                <div className="space-y-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setDados((prev) => ({ ...prev, estadoEndereco: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Selecione o estado" />
              ...
              <div className="space-y-4">
                ...
                <Input
                  ...
                  value={dados.rua}
                  onChange={(e) =>
                    setDados((prev) => ({ ...prev, rua: e.target.value }))
                  }
                />
              </div>
