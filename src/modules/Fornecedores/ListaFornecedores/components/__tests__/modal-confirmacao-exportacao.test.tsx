...
describe('ModalConfirmacaoExportacao', () => {
  ...
  it('deve renderizar quando isOpen for true', () => {
    ...
    expect(screen.getByText('Você está prestes a exportar todos os fornecedores.')).toBeInTheDocument()
  })
  ...
  it('deve ter mensagem explicativa clara', () => {
    ...
    expect(screen.getByText('Você está prestes a exportar todos os fornecedores.')).toBeInTheDocument()
    expect(screen.getByText('Esta ação irá gerar um arquivo CSV com todos os dados dos fornecedores listados.')).toBeInTheDocument()
  })
  ...
  it('deve ter estrutura semântica correta', () => {
    ...
    expect(screen.getByRole('heading')).toHaveTextContent('Confirmar Exportação')
  })
